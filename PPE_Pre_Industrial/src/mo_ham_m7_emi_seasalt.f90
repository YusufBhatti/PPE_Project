...
!	       pnumf_cs(1:kproma)  = pnumf_cs(1:kproma) * scale_emi_ssa
!	       pmassf_cs(1:kproma) = pmassf_cs(1:kproma) * scale_emi_ssa
!	       pnumf_as(1:kproma)  = pnumf_as(1:kproma) * scale_emi_ssa
!	       pmassf_as(1:kproma) = pmassf_as(1:kproma) * scale_emi_ssa
!	       znumf_ks(1:kproma)  = znumf_ks(1:kproma) * scale_emi_ssa 
!	       zmassf_ks(1:kproma) = zmassf_ks(1:kproma) * scale_emi_ssa
!       ENDIF
    END DO
