...
! Local variables
  ...
  !>>dwp factored out the proportions of tracer emmited above and below the PBL
  REAL(dp)  :: zfrac_abv1, zfrac_abv2, zfrac_blw
  !<<dwp
...
!  ELSE
  ...
  zbc2d_blw(1:kproma)=zfrac_blw*zbc2d(1:kproma)
