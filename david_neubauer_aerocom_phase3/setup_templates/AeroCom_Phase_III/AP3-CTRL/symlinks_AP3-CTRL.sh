...
ln -sf ${input_basepath}/echam6/greenhouse_ssp370.nc  greenhouse_gases.nc
...
ln -sf  ${input_basepath}/jsbach/${hres}/jsbach_${hres}${oceres}_${ntiles}tiles_5layers_2005_no-dynveg.nc jsbach.nc
...
ln -sf ${input_basepath}/echam6/${hres}/amip/${hres}_amipsst_2000-2015_mean.nc unit.20
ln -sf ${input_basepath}/echam6/${hres}/amip/${hres}_amipsic_2000-2015_mean.nc unit.96
...
if $flag_CMIP5_ozon ; then  # ie io3=4
   ...
   #        fi
   #        ln -sf ${input_basepath}/echam6/${hres}/ozone/${hres}_ozone_historical_${year}.nc ozon${year}

   #     else # fake year-dep input for using the CMIP5 climatology
          ln -sf /cluster/work/climate/ferrachs/echam_input/echam6-hammoz/v0002//echam6/${hres}/${hres}_ozone_CMIP5_1979-1988.nc ozon${year}
   #    fi
   done
