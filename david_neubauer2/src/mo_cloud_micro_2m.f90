...
!davidn
  USE mo_activ,          ONLY :&
!>>DN: new diagnostics
                              cloud_cover_begin_micro_2m, cloud_tm2, qeva,     & 
                              pnucncd,pcdncactevap,pnucnic,                    &
                              pevapncd,pevapncdbf,                             &
                              pcdncactfrz,pfrzncd,                             &
                              picncactmelt,pmeltncd,                           &
                              picncactsub,psubnic, pcdncactap,                 &
                              picncactap, dpg, reffl, reffi, w_large, w_turb,  &  
!<<DN: new diagnostics             
!>>SF Kasja diags
...
!davidn SLF
USE mo_debugs,             ONLY: ddf01,ddf02,ddf03,ddf04,zdf01,zdf02,zdf03,zdf04,zdf05,ddf05
USE mo_debugs,             ONLY: ddf07,ddf08,ddf09,ddf10,ddf11
USE mo_debugs,             ONLY: zdf15,zdf16,zdf17,zdf18,zdf19,zdf20,zdf21
USE mo_debugs,             ONLY: zdf22,zdf23,zdf24,zdf25,zdf26,zdf27,zdf28
USE mo_debugs,             ONLY: zdf33,zdf34,zdf35,zdf36,zdf37,zdf38,zdf39,zdf40,zdf41,zdf42
USE mo_debugs,             ONLY: zdf43,zdf44,zdf45,zdf46,zdf47,zdf48,zdf49,zdf50,zdf51,zdf52
USE mo_debugs,             ONLY: zdf53,zdf54,zdf55,zdf56,zdf57,zdf58,zdf59,zdf60
!davidn
  IMPLICIT NONE
...
!>>DN: new diagnostics
  pnucncd(1:kproma,:,krow)        = 0.0_dp
  pcdncactevap(1:kproma,:,krow)   = 0.0_dp
  pevapncd(1:kproma,:,krow)       = 0.0_dp
  pevapncdbf(1:kproma,:,krow)     = 0.0_dp
  pcdncactfrz(1:kproma,:,krow)    = 0.0_dp
  pfrzncd(1:kproma,:,krow)        = 0.0_dp
  picncactmelt(1:kproma,:,krow)   = 0.0_dp
  pmeltncd(1:kproma,:,krow)       = 0.0_dp
  picncactsub(1:kproma,:,krow)    = 0.0_dp
  psubnic(1:kproma,:,krow)        = 0.0_dp
  pnucnic(1:kproma,:,krow)        = 0.0_dp
  cloud_cover_begin_micro_2m(1:kproma,:,krow) = paclc(1:kproma,:) 
!<<DN: new diagnostics
...
!>>DN: new diagnostics
        !nucleation in previously cloud-free part of the gridbox
     ll1(1:kproma) = (paclc(1:kproma,jk) > cloud_tm2(1:kproma,jk,krow)) .AND. &
          (cloud_tm2(1:kproma,jk,krow) > eps)
     ztmp1(1:kproma) = (paclc(1:kproma,jk)-cloud_tm2(1:kproma,jk,krow))*&
          zrho_rcp(1:kproma,jk)
     
     ztmp2(1:kproma)   = pnucncd(1:kproma,jk,krow) + ztmp1(1:kproma)*zcdnc(1:kproma,jk)
     pnucncd(1:kproma,jk,krow) = &
          MERGE(ztmp2(1:kproma), pnucncd(1:kproma,jk,krow), ll1(1:kproma))
     
     ztmp2(1:kproma)   = pnucnic(1:kproma,jk,krow) + ztmp1(1:kproma)*picnc(1:kproma,jk)
     pnucnic(1:kproma,jk,krow) = &
          MERGE(ztmp2(1:kproma), pnucnic(1:kproma,jk,krow), ll1(1:kproma))
        !end corinna: nucleation in previously cloud-free part of the gridbox

        !evaporation in previously cloudy part of the gridbox
     ll1(1:kproma) = (paclc(1:kproma,jk) <= cloud_tm2(1:kproma,jk,krow)) .AND. &
          (paclc(1:kproma,jk) >  eps                )
     ll2(1:kproma) = ll1(1:kproma) .AND. &
          (pxtm1(1:kproma,jk,idt_icnc) >= eps)
     
     ztmp1(1:kproma)        = MAX(pxtm1(1:kproma,jk,idt_cdnc),zcdnc_min(1:kproma,jk)*zrho_rcp(1:kproma,jk))
     ztmp1(1:kproma)        = ztmp1(1:kproma) * cloud_tm2(1:kproma,jk,krow)
     pcdncactevap(1:kproma,jk,krow) = &
          MERGE(ztmp1(1:kproma), pcdncactevap(1:kproma,jk,krow), ll1(1:kproma))
     
     ztmp1(1:kproma)    = (cloud_tm2(1:kproma,jk,krow) - paclc(1:kproma,jk)) * &
          pxtm1(1:kproma,jk,idt_cdnc)
     pevapncd(1:kproma,jk,krow) = &
          MERGE(ztmp1(1:kproma), pevapncd(1:kproma,jk,krow), ll1(1:kproma))
     
     ztmp1(1:kproma)       = MAX(pxtm1(1:kproma,jk,idt_icnc),icemin*zrho_rcp(1:kproma,jk))
     ztmp1(1:kproma)       = ztmp1(1:kproma) * cloud_tm2(1:kproma,jk,krow)
     picncactsub(1:kproma,jk,krow) = &
          MERGE(ztmp1(1:kproma), picncactsub(1:kproma,jk,krow), ll2(1:kproma))
     
     ztmp1(1:kproma)   = (cloud_tm2(1:kproma,jk,krow)-paclc(1:kproma,jk)) * &
          pxtm1(1:kproma,jk,idt_icnc) 
     psubnic(1:kproma,jk,krow) = &
          MERGE(ztmp1(1:kproma), psubnic(1:kproma,jk,krow), ll1(1:kproma))
        !end corinna: evaporation in previously cloudy part of the gridbox!
!<<DN: new diagnostics
...
!>>DN: new diagnostics
     ztmp1_2d(1:kproma,:) = pnucncd(1:kproma,:,krow) + paclc(1:kproma,:)*zqlnuc(1:kproma,:)*zrho_rcp(1:kproma,:) !in [#/kg]
     pnucncd(1:kproma,:,krow) = MERGE(ztmp1_2d(1:kproma,:), pnucncd(1:kproma,:,krow), ll1_2d(1:kproma,:))
!<<DN: new diagnostics
...
!>>DN: new diagnostics 
     ztmp1_2d(1:kproma,:)    = pnucncd(1:kproma,:,krow) +&
          paclc(1:kproma,:)*(zcdnc_bas(1:kproma,:)-(zcdnc(1:kproma,:)-zqlnuc(1:kproma,:)))*zrho_rcp(1:kproma,:)
     pnucncd(1:kproma,:,krow) = MERGE(ztmp1_2d(1:kproma,:), pnucncd(1:kproma,:,krow), ll1_2d(1:kproma,:))
!<<DN: new diagnostics
...
!>>DN: new diags
  zcorric2(1:kproma,:) = zcd2ic_2d(1:kproma,:)
...
!<<DN: new diags
  ...
  !>>DN: new diagnostics
  ztmp1_2d(1:kproma,:) = pnucncd(1:kproma,:,krow) + paclc(1:kproma,:)*zqlnuccv(1:kproma,:)*zrho_rcp(1:kproma,:)         !in [#/kg]
  pnucncd(1:kproma,:,krow) = MERGE(ztmp1_2d(1:kproma,:), pnucncd(1:kproma,:,krow), ll3_2d(1:kproma,:))
  !<<DN: new diagnostics
...
!<<DN 2013-07-05 #271: removed the former IWC weigthing
  ...
  !>>DN: new diagnostics
  ztmp1_2d(1:kproma,:) = pnucnic(1:kproma,:,krow) + paclc(1:kproma,:)*znidetr(1:kproma,:)*zrho_rcp(1:kproma,:)
  pnucnic(1:kproma,:,krow) = MERGE(ztmp1_2d(1:kproma,:), pnucnic(1:kproma,:,krow), ll_cv(1:kproma,:))
  !<<DN: new diagnostics
...
!SF modified the cond. statement
  IF ( nic_cirrus == 1 ) THEN ! Use ICNC scheme after Lohmann, JAS, 2002
     ...
     !>>DN: new diagnostics
     ztmp1_2d(1:kproma,:) = pnucnic(1:kproma,:,krow) + paclc(1:kproma,:)*zninucl(1:kproma,:)*zrho_rcp(1:kproma,:)
     pnucnic(1:kproma,:,krow) = MERGE(ztmp1_2d(1:kproma,:), pnucnic(1:kproma,:,krow), ll_cv(1:kproma,:))
     !<<DN: new diagnostics
...
!--- Update ICNC
     ...
     !>>DN: new diagnostics
     ztmp1_2d(1:kproma,:) = pnucnic(1:kproma,:,krow) + paclc(1:kproma,:)*zninucl(1:kproma,:)*zrho_rcp(1:kproma,:)
     pnucnic(1:kproma,:,krow) = MERGE(ztmp1_2d(1:kproma,:), pnucnic(1:kproma,:,krow), ll_ice(1:kproma,:))
     !<<DN: new diagnostics
...
!       3.1   Melting of snow and ice
        ...
        !>>DN: new diagnostics
        picncactmelt(1:kproma,jk,krow) = paclc(1:kproma,jk)*zicncq(1:kproma,jk)*zrho_rcp(1:kproma,jk)
...
!>>DN: new diagnostics
        pmeltncd(1:kproma,jk,krow)=paclc(1:kproma,jk)*ztmp1(1:kproma)*zrho_rcp(1:kproma,jk)
!<<DN: new diagnostics 
!>>DN: burden
...
!              subroutine). Maybe reconsider later?
        ...
        !>>DN: new diagnostics
        pcdncactevap(1:kproma,jk,krow) = cloud_tm2(1:kproma,jk,krow)*&
             MAX(zcdnc(1:kproma,jk),zcdnc_min(1:kproma,jk))*zrho_rcp(1:kproma,jk)
        !<<DN: new diagnostics
!
...
!
        ...
        !>>DN: new diagnostics
        ztmp1(1:kproma)=0._dp
        pcdncactfrz(1:kproma,jk,krow) = paclc(1:kproma,jk)*zcdnc(1:kproma,jk)*zrho_rcp(1:kproma,jk) !set here because inner loop is not always reached
        !<<DN: new diagnostics
        ...
        !>>DN: new diagnostics
!                   zfrl(:,jk), zxib(:,jk), zxlb(:,jk), zfrzn(:) )
                   zfrl(:,jk), zxib(:,jk), zxlb(:,jk), zfrzn(:), ztmp1(:) )
        !<<DN: new diagnostics
!>>DN: new diags
        zcorrcd10(1:kproma) = MERGE(-ztmp1(1:kproma),0._dp , ll_frz_below_238K(1:kproma))
!<<DN: new diags        
        !>>DN: new diagnostics
        ztmp2(1:kproma)   = paclc(1:kproma,jk)*ztmp1(1:kproma)*zrho_rcp(1:kproma,jk)
        pfrzncd(1:kproma,jk,krow) = MERGE(ztmp2(1:kproma), pfrzncd(1:kproma,jk,krow), ll_frz_below_238K(1:kproma))
        !<<DN: new diagnostics
...
!<<DN: burden
!>>DN: new diagnostics
        ztmp1(1:kproma)=zcdnc(1:kproma,jk)
!<<DN: new diagnostics
...
!<<SF Kasja diags
!>>DN: new diagnostics
           ztmp2(1:kproma) = paclc(1:kproma,jk)*MIN(zfrln(1:kproma,jk),ztmp1(1:kproma)-cqtmin)*zrho_rcp(1:kproma,jk)
           pfrzncd(1:kproma,jk,krow) = MERGE(ztmp2(1:kproma), pfrzncd(1:kproma,jk,krow), ll_mxphase_frz(1:kproma))
!<<DN: new diagnostics
...
!>>DN: new diagnostics
              ztmp1(1:kproma)     = MAX(0._dp,zcdnc(1:kproma,jk)-cqtmin)
              ztmp2(1:kproma)     = paclc(1:kproma,jk)*ztmp1(1:kproma)*zrho_rcp(1:kproma,jk)
              pevapncdbf(1:kproma,jk,krow) = MERGE(ztmp2(1:kproma), pevapncdbf(1:kproma,jk,krow), ll_WBF(1:kproma))
              ztmp2(1:kproma)     = qeva(1:kproma,jk,krow) - zdt*ztmp1(1:kproma)
              qeva(1:kproma,jk,krow) = MERGE(ztmp2(1:kproma), qeva(1:kproma,jk,krow), ll_WBF(1:kproma))
!<<DN: new diagnostics
...
!davidn SLF
    ...
    DO jk=1,klev
       picnc(1:kproma,jk)  = zrho(1:kproma,jk)*(pxtm1(1:kproma,jk,idt_icnc) + ztmst*pxtte(1:kproma,jk,idt_icnc))
       picnc(1:kproma,jk)  = MAX(picnc(1:kproma,jk),cqtmin)
       ll1(1:kproma) = (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk)+pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps)
       ll2(:) = ll1(:)

       ztmp1(1:kproma) = 1000._dp*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))*zdpg(1:kproma,jk)  ! lwp in g/m2
       ztmp2(1:kproma) = 1000._dp*(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))*zdpg(1:kproma,jk)  ! iwp in g/m2
       ztmp3(1:kproma) = ztau1i(1:kproma) + 1.8362_dp*ztmp1(1:kproma)*MAX(reffl(1:kproma,jk,krow),2._dp)**(-1.0665_dp) &
            + 1.9787_dp*ztmp2(1:kproma)*MAX(reffi(1:kproma,jk,krow),4._dp)**(-1.0365_dp)
       ll3(1:kproma) = (ztau1i(1:kproma) == 0._dp)
       ztau1i(1:kproma)   = MERGE(ztmp3(1:kproma), ztau1i(1:kproma), ll2(1:kproma))
       
       ll3(1:kproma) = ll2(1:kproma).AND.((ztau1i(1:kproma) < 3._dp) .OR. ll3(1:kproma))
       
       ll4(1:kproma) = ll3(1:kproma) .AND. &
            (((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))) > eps) &
            .AND. (ztp1h(1:kproma,jk) < 263.15) .AND.  (ztp1h(1:kproma,jk+1) > 263.15)
       zdf15(1:kproma,krow) = zdf15(1:kproma,krow)+MERGE(zdtime*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            ((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))), 0._dp, ll4(1:kproma))
       zdf22(1:kproma,krow) = zdf22(1:kproma,krow)+MERGE(zdtime, 0._dp, ll4(1:kproma))
       
       ll4(1:kproma) = ll3(1:kproma) .AND. &
            (((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))) > eps) &
            .AND. (ztp1h(1:kproma,jk) < 258.15) .AND.  (ztp1h(1:kproma,jk+1) > 258.15)
       zdf16(1:kproma,krow) = zdf16(1:kproma,krow)+MERGE(zdtime*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            ((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))), 0._dp, ll4(1:kproma))
       zdf23(1:kproma,krow) = zdf23(1:kproma,krow)+MERGE(zdtime, 0._dp, ll4(1:kproma))
       
       ll4(1:kproma) = ll3(1:kproma) .AND. &
            (((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))) > eps) &
            .AND. (ztp1h(1:kproma,jk) < 253.15) .AND.  (ztp1h(1:kproma,jk+1) > 253.15)
       zdf17(1:kproma,krow) = zdf17(1:kproma,krow)+MERGE(zdtime*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            ((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))), 0._dp, ll4(1:kproma))
       zdf24(1:kproma,krow) = zdf24(1:kproma,krow)+MERGE(zdtime, 0._dp, ll4(1:kproma))
       
       ll4(1:kproma) = ll3(1:kproma) .AND. &
            (((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))) > eps) &
            .AND. (ztp1h(1:kproma,jk) < 248.15) .AND.  (ztp1h(1:kproma,jk+1) > 248.15)
       zdf18(1:kproma,krow) = zdf18(1:kproma,krow)+MERGE(zdtime*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            ((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))), 0._dp, ll4(1:kproma))
       zdf25(1:kproma,krow) = zdf25(1:kproma,krow)+MERGE(zdtime, 0._dp, ll4(1:kproma))

       ll4(1:kproma) = ll3(1:kproma) .AND. &
            (((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))) > eps) &
             .AND. (ztp1h(1:kproma,jk) < 243.15) .AND.  (ztp1h(1:kproma,jk+1) > 243.15)
       zdf19(1:kproma,krow) = zdf19(1:kproma,krow)+MERGE(zdtime*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            ((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))), 0._dp, ll4(1:kproma))
       zdf26(1:kproma,krow) = zdf26(1:kproma,krow)+MERGE(zdtime, 0._dp, ll4(1:kproma))

       ll4(1:kproma) = ll3(1:kproma) .AND. &
            (((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))) > eps) &
            .AND. (ztp1h(1:kproma,jk) < 238.15) .AND.  (ztp1h(1:kproma,jk+1) > 238.15)
       zdf20(1:kproma,krow) = zdf20(1:kproma,krow)+MERGE(zdtime*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            ((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))), 0._dp, ll4(1:kproma))
       zdf27(1:kproma,krow) = zdf27(1:kproma,krow)+MERGE(zdtime, 0._dp, ll4(1:kproma))
       
       ll4(1:kproma) = ll3(1:kproma) .AND. &
            (((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))) > eps)
       zdf21(1:kproma,krow) = zdf21(1:kproma,krow)+MERGE(zdtime*(pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            ((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))+(pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk))), 0._dp, ll4(1:kproma))
       zdf28(1:kproma,krow) = zdf28(1:kproma,krow)+MERGE(zdtime, 0._dp, ll4(1:kproma))
       ll1(1:kproma) = (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps)
       ddf10(1:kproma,jk,krow) = ddf10(1:kproma,jk,krow)+MERGE((pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk))/&
            (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk)+pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk)), 0._dp, ll1(1:kproma))
       
       ll5(1:kproma) = ll2(1:kproma) .AND. &
            (ztp1h(1:kproma,jk) < 268.15) .AND. (ztp1h(1:kproma,jk+1) > 268.15)
       ll6(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) < eps)
       ll7(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       ll8(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) < eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       zdf33(1:kproma,krow) = zdf33(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll5(1:kproma))
       zdf34(1:kproma,krow) = zdf34(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll6(1:kproma))
       zdf35(1:kproma,krow) = zdf35(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll7(1:kproma))
       zdf36(1:kproma,krow) = zdf36(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll8(1:kproma))

       ll5(1:kproma) = ll2(1:kproma) .AND. &
            (ztp1h(1:kproma,jk) < 263.15) .AND. (ztp1h(1:kproma,jk+1) > 263.15)
       ll6(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) < eps)
       ll7(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       ll8(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) < eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       zdf37(1:kproma,krow) = zdf37(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll5(1:kproma))
       zdf38(1:kproma,krow) = zdf38(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll6(1:kproma))
       zdf39(1:kproma,krow) = zdf39(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll7(1:kproma))
       zdf40(1:kproma,krow) = zdf40(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll8(1:kproma))

       ll5(1:kproma) = ll2(1:kproma) .AND. &
            (ztp1h(1:kproma,jk) < 258.15) .AND. (ztp1h(1:kproma,jk+1) > 258.15)
       ll6(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) < eps)
       ll7(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       ll8(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) < eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       zdf41(1:kproma,krow) = zdf41(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll5(1:kproma))
       zdf42(1:kproma,krow) = zdf42(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll6(1:kproma))
       zdf43(1:kproma,krow) = zdf43(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll7(1:kproma))
       zdf44(1:kproma,krow) = zdf44(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll8(1:kproma))

       ll5(1:kproma) = ll2(1:kproma) .AND. &
            (ztp1h(1:kproma,jk) < 253.15) .AND. (ztp1h(1:kproma,jk+1) > 253.15)
       ll6(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) < eps)
       ll7(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       ll8(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) < eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       zdf45(1:kproma,krow) = zdf45(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll5(1:kproma))
       zdf46(1:kproma,krow) = zdf46(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll6(1:kproma))
       zdf47(1:kproma,krow) = zdf47(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll7(1:kproma))
       zdf48(1:kproma,krow) = zdf48(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll8(1:kproma))

       ll5(1:kproma) = ll2(1:kproma) .AND. &
            (ztp1h(1:kproma,jk) < 248.15) .AND. (ztp1h(1:kproma,jk+1) > 248.15)
       ll6(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) < eps)
       ll7(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       ll8(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) < eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       zdf49(1:kproma,krow) = zdf49(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll5(1:kproma))
       zdf50(1:kproma,krow) = zdf50(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll6(1:kproma))
       zdf51(1:kproma,krow) = zdf51(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll7(1:kproma))
       zdf52(1:kproma,krow) = zdf52(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll8(1:kproma))

       ll5(1:kproma) = ll2(1:kproma) .AND. &
            (ztp1h(1:kproma,jk) < 243.15) .AND. (ztp1h(1:kproma,jk+1) > 243.15)
       ll6(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) < eps)
       ll7(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       ll8(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) < eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       zdf53(1:kproma,krow) = zdf53(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll5(1:kproma))
       zdf54(1:kproma,krow) = zdf54(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll6(1:kproma))
       zdf55(1:kproma,krow) = zdf55(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll7(1:kproma))
       zdf56(1:kproma,krow) = zdf56(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll8(1:kproma))

       ll5(1:kproma) = ll2(1:kproma) .AND. &
            (ztp1h(1:kproma,jk) < 238.15) .AND. (ztp1h(1:kproma,jk+1) > 238.15)
       ll6(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) < eps)
       ll7(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) > eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       ll8(1:kproma) = ll5(1:kproma) .AND. &
            (pxlm1(1:kproma,jk)+ztmst*pxlte(1:kproma,jk) < eps) .AND. (pxim1(1:kproma,jk)+ztmst*pxite(1:kproma,jk) > eps)
       zdf57(1:kproma,krow) = zdf57(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll5(1:kproma))
       zdf58(1:kproma,krow) = zdf58(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll6(1:kproma))
       zdf59(1:kproma,krow) = zdf59(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll7(1:kproma))
       zdf60(1:kproma,krow) = zdf60(1:kproma,krow)+MERGE(zdtime*(ztmp1(1:kproma)+ztmp2(1:kproma)), 0._dp, ll8(1:kproma))
    END DO
!davidn
...
!>>DN: new diagnostics
  pcdncactap(1:kproma,:,krow) = zcdnc(1:kproma,:)
  picncactap(1:kproma,:,krow) = picnc(1:kproma,:)
!<<DN: new diagnostics
...
!>>DN: new diagnostics
     cloud_tm2(1:kproma,:,krow) = cloud_cover_duplic(1:kproma,:,krow) !save CC from t-2 because of leapfrog-scheme 
!<<DN: new diagnostics
...
!>>DN: new diagnostics
  REAL(dp), INTENT(out) :: ptmp1(kbdim)
!<<DN: new diagnostics 
...
!DN: update of in cloud water/ice, CDNC/ICNC(activation/nucleation), cloud cover
  ...
  REAL(dp), INTENT(in) :: ptm1(kbdim)     !< temperature (t-1)
!>>DN: new diagnostics
  INTEGER, INTENT(in) :: jk, krow
  REAL(dp), INTENT(in) :: prho_rcp(kbdim)  !< Inverse air density [m3/kg]
!<<DN: new diagnostics 
...
!>>DN: new diagnostics
  REAL(dp) :: zclcaux(kbdim), ztmp5(kbdim)
  REAL(dp) :: zclcaux_lim
  LOGICAL  :: ll3(kbdim), ll4(kbdim), ll5(kbdim), ll6(kbdim)
  LOGICAL  :: llclcaux(kbdim), llcloudtm2(kbdim)
!<<DN: new diagnostics
...
!>>DN: new diagnostics
  zclcaux_lim= 1.e-4_dp
  zclcaux(1:kproma) = paclc(1:kproma)
  zqlnuc(1:kproma) = 0._dp
!<<DN: new diagnostics
...
!>>DN: new diagnostics
  !corinna: nucleation in previously cloud-free part of the gridbox
  ll3(1:kproma) = ll1(1:kproma) .AND. (paclc(1:kproma) > zclcaux(1:kproma))
        
  ztmp1(1:kproma)   = pnucncd(1:kproma,jk,krow) + &
       (paclc(1:kproma) - zclcaux(1:kproma))*pcdnc(1:kproma)*prho_rcp(1:kproma)
  pnucncd(1:kproma,jk,krow) = &
       MERGE(ztmp1(1:kproma), pnucncd(1:kproma,jk,krow), ll3(1:kproma))
  !end corinna: nucleation in previously cloud-free part of the gridbox

  ztmp1(1:kproma)  = pnucncd(1:kproma,jk,krow) + &
       paclc(1:kproma)*zqlnuc(1:kproma)*prho_rcp(1:kproma)
  pnucncd(1:kproma,jk,krow) = &
       MERGE(ztmp1(1:kproma), pnucncd(1:kproma,jk,krow), ll2(1:kproma)) 
  
  llclcaux(1:kproma)   = (paclc(1:kproma) > zclcaux_lim)
  llcloudtm2(1:kproma) = (cloud_tm2(1:kproma,jk,krow) >= zclcaux_lim)
  ll3(1:kproma) = (pcdnc(1:kproma) > cqtmin)
  
  ll4(1:kproma) = .NOT. ll1(1:kproma) .AND. llclcaux(1:kproma)
  ll5(1:kproma) = .NOT. ll1(1:kproma) &
       .AND. .NOT. llclcaux(1:kproma) .AND. llcloudtm2(1:kproma)
  ll6(1:kproma) = .NOT. ll1(1:kproma) &
       .AND. .NOT. llclcaux(1:kproma) .AND. ll3(1:kproma)
  
  WHERE (ll4(1:kproma))
     !cloud droplets evaporate because there is no liquid water (only ice)
     pevapncd(1:kproma,jk,krow) = pevapncd(1:kproma,jk,krow)                                 &
          + paclc(1:kproma)*(pcdnc(1:kproma)-cqtmin)*prho_rcp(1:kproma)
     
  ELSEWHERE (ll5(1:kproma))
     !cloud droplets evaporate because the cloud cover is 0
     pevapncd(1:kproma,jk,krow) = pevapncd(1:kproma,jk,krow)                                           &
          + cloud_tm2(1:kproma,jk,krow)*(pcdnc(1:kproma)-cqtmin)*prho_rcp(1:kproma)
     
  ELSEWHERE (ll6(1:kproma))
     !cloud droplets evaporate because the cloud cover is 0
     pcdncactevap(1:kproma,jk,krow) = pcdnc(1:kproma) * prho_rcp(1:kproma)
     pevapncd(1:kproma,jk,krow)     = pevapncd(1:kproma,jk,krow) + pcdncactevap(1:kproma,jk,krow)
...
!>>DN: new diagnostics
!>>DN [discriminate between different cirrus schemes]
  IF (nic_cirrus == 1) THEN
     ztmp2(1:kproma) = pnucnic(1:kproma,jk,krow) + ztmp1(1:kproma)*prho_rcp(1:kproma)*paclc(1:kproma)
  ELSE
     ztmp2(1:kproma) = pnucnic(1:kproma,jk,krow) + ztmp1(1:kproma)
  END IF
!<<DN
  pnucnic(1:kproma,jk,krow) = MERGE(ztmp2(1:kproma), pnucnic(1:kproma,jk,krow), ll2(1:kproma))
!<<DN: new diagnostics
...
!>>DN: new diagnostics
  !calc of diameter even there is no sub:
  ll3(1:kproma) = ll1(1:kproma) .AND. (picncactsub(1:kproma,jk,krow) < cqtmin)
  
  ztmp2(1:kproma)       = paclc(1:kproma)*ztmp1(1:kproma)*prho_rcp(1:kproma)
  picncactsub(1:kproma,jk,krow) = MERGE(ztmp2(1:kproma), picncactsub(1:kproma,jk,krow), ll3(1:kproma))

  ztmp3(1:kproma)       = MERGE(cloud_tm2(1:kproma,jk,krow)*ztmp1(1:kproma)*prho_rcp(1:kproma),&
       picnc(1:kproma)*prho_rcp(1:kproma), llcloudtm2(1:kproma))
  picncactsub(1:kproma,jk,krow) = MERGE(picncactsub(1:kproma,jk,krow), ztmp3(1:kproma), ll1(1:kproma))
        
  ztmp2(1:kproma)   = MAX(ztmp1(1:kproma)-cqtmin,0._dp)
  ztmp3(1:kproma)   = psubnic(1:kproma,jk,krow) + &
       cloud_tm2(1:kproma,jk,krow)*ztmp2(1:kproma)*prho_rcp(1:kproma)
  ztmp4(1:kproma)   = psubnic(1:kproma,jk,krow) + picncactsub(1:kproma,jk,krow)*prho_rcp(1:kproma)
  ztmp5(1:kproma)   = MERGE(ztmp3(1:kproma), ztmp4(1:kproma), llcloudtm2(1:kproma))
  psubnic(1:kproma,jk,krow) = MERGE(psubnic(1:kproma,jk,krow), ztmp5(1:kproma), ll1(1:kproma))
!<<DN: new diagnostics
...
SUBROUTINE freezing_below_238K( &
              ...
              !-- INOUT
!>>DN: new diagnostics
!              picnc, pqfre, pcdnc, pfrl, pxib, pxlb, pfrzn)
              picnc, pqfre, pcdnc, pfrl, pxib, pxlb, pfrzn, ptmp1)
!<<DN: new diagnostics
...
!<<DN #475 (min cdnc)
  ...
  REAL(dp), INTENT(out) :: pfrzn(kbdim)
!>>DN: new diagnostics
  REAL(dp), INTENT(out) :: ptmp1(kbdim)
!<<DN: new diagnostics
...
SUBROUTINE WBF_process( &
              ...
              !-- INOUT
              pcdnc, pxlb, pxib, pxlte, pxite, ptte, pevabf, plwcbf)
...
!davidn bugfix Steffen
!     pxlb(1:kproma) = pxlb(1:kproma) - zrac1(1:kproma)
     WHERE(paclc(1:kproma)>eps)
        pxlb(1:kproma) = pxlb(1:kproma) - pclcstar(1:kproma)/paclc(1:kproma)*zrac1(1:kproma)
     END WHERE
!davidn bugfix Steffen
...
!     ztmp1(1:kproma)    = zraut(1:kproma)+zrac1(1:kproma)+zrac2(1:kproma)
     WHERE(paclc(1:kproma)>eps)
        ztmp1(1:kproma)    = zraut(1:kproma)+pclcstar(1:kproma)/paclc(1:kproma)*zrac1(1:kproma)+zrac2(1:kproma)
     END WHERE
!davidn bugfix Steffen
...
SUBROUTINE precip_formation_cold( &
  ...
  REAL(dp), INTENT(out) :: psaut(kbdim),psaci(kbdim),paggn(kbdim),psacin(kbdim),pselfn(kbdim),psecprodn(kbdim),psecprod(kbdim) !davidn
...
!davidn bugfix Remo
!also the riming of cloud droplets with snow is compute in this subroutine which doesn't require cloud ice
!therefore the condition for cloud ice is removed also here
!  IF (.NOT. ANY(ll1(1:kproma))) return
  IF (.NOT. ANY(ld_cc(1:kproma))) return
!davidn
!<<SF
...
!  zxsp(1:kproma) = pxsp1(1:kproma) + zxsp2(1:kproma)
  zxsp(1:kproma) = 0._dp
  WHERE(paclc(1:kproma)>eps)
     zxsp(1:kproma) = pclcstar(1:kproma)/paclc(1:kproma)*pxsp1(1:kproma) + zxsp2(1:kproma)
  END WHERE
!davidn bugfix Steffen

!davidn bugfix Remo
!  ll2(1:kproma) = ll1(1:kproma)               .AND. &
  ll2(1:kproma) = ld_cc(1:kproma)               .AND. &
!davidn bugfix Remo
...
!>>DN: new diagnostics
  ll3(1:kproma) = (zxlp1(1:kproma) < -eps) .AND. (pcdnc(1:kproma) > eps)
  
  ztmp1(1:kproma) = paclc(1:kproma)*pcdnc(1:kproma)*prho_rcp(1:kproma)
  ztmp1(1:kproma) = MERGE(ztmp1(1:kproma), 0._dp, ll3(1:kproma))
        
  pcdncactevap(1:kproma,jk,krow) = MAX(pcdncactevap (1:kproma,jk,krow), ztmp1(1:kproma))
  pevapncd(1:kproma,jk,krow)     = pevapncd(1:kproma,jk,krow) + ztmp1(1:kproma)
  pnucncd(1:kproma,jk,krow)      = MERGE(0._dp, pnucncd(1:kproma,jk,krow), ll3(1:kproma))
        
  ll3(1:kproma) = ll2(1:kproma) .AND. (picnc(1:kproma) > eps)
        
  ztmp1(1:kproma) = paclc(1:kproma)*picnc(1:kproma)*prho_rcp(1:kproma)
  ztmp1(1:kproma) = MERGE(ztmp1(1:kproma), 0._dp, ll3(1:kproma))
  
  picncactsub(1:kproma,jk,krow) = MAX(picncactsub(1:kproma,jk,krow), ztmp1(1:kproma))
  psubnic(1:kproma,jk,krow)     = psubnic(1:kproma,jk,krow) + ztmp1(1:kproma)
  pnucnic(1:kproma,jk,krow)     = MERGE(0._dp, pnucnic(1:kproma,jk,krow), ll3(1:kproma))
!<<DN: new diagnostics
