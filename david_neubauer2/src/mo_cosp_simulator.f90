...
!<<KH
    ...
    REAL(wp), DIMENSION(kproma, klev)    :: tca		 ! Total Cloud Fraction at each level, from TOA to SURFACE [0-1]
...
!gbx
    ...
    INTEGER :: k,j,i, itau, ipres, jk, jkb, jl, Nlr
...
!---------------------------------------------------------------------------------    
    ...
    !++++++++++ Allocate memory ++++++++++
        ...
        call construct_cosp_isccpstats(cfg,kproma,Ncolumns,klev,isccp)
