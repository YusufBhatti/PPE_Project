...
!davidn
  ...
  USE mo_param_switches,     ONLY: tun31zinhomi,tun31zinhoml1,tun31zinhoml2,tun31zinhoml3,tun31zinpar 
!davidn
    ...
    IF (lcdnc_progn) THEN
       IF (nn == 63) THEN
          IF (nlev == 31) THEN
             ...
             END SELECT
!davidn tuning          
             zinhomi = tun31zinhomi
             zinhoml1= tun31zinhoml1
             zinhoml2= tun31zinhoml2
             zinhoml3= tun31zinhoml3
!davidn
