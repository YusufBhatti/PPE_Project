...
!<<SF
!davidn convfreq
  USE mo_debugs,         ONLY: zdf07, zdf08, zdf09, zdf10
!davidn
...
!davidn convfreq
    WHERE(itype(1:nproma)==0) !no convection
       zdf07(1:nproma,krow)=zdf07(1:nproma,krow)+zdtime
    ELSEWHERE(itype(1:nproma)==1) !deep convection
       zdf08(1:nproma,krow)=zdf08(1:nproma,krow)+zdtime
    ELSEWHERE(itype(1:nproma)==2) !shallow convection
       zdf09(1:nproma,krow)=zdf09(1:nproma,krow)+zdtime
    ELSEWHERE(itype(1:nproma)==3) !midlevel convection
       zdf10(1:nproma,krow)=zdf10(1:nproma,krow)+zdtime
    END WHERE
!davidn
