...
!>>DN: aerosol processing
  ! Aerosol processing timers
  INTEGER, PUBLIC :: timer_aeroproc_nuc
  INTEGER, PUBLIC :: timer_aeroproc_nuci
  INTEGER, PUBLIC :: timer_aeroproc_evap
  INTEGER, PUBLIC :: timer_aeroproc_melt
  INTEGER, PUBLIC :: timer_aeroproc_freeze
  INTEGER, PUBLIC :: timer_aeroproc_subl
  INTEGER, PUBLIC :: timer_aeroproc_coll
!<<DN: aerosol processing
...
!>>DN: aerosol processing
  ! Aerosol processing timers
    timer_aeroproc_nuc      = new_timer("aeroproc_nuc")
    timer_aeroproc_nuci     = new_timer("aeroproc_nuci")
    timer_aeroproc_evap     = new_timer("aeroproc_evap")
    timer_aeroproc_melt     = new_timer("aeroproc_melt")
    timer_aeroproc_freeze   = new_timer("aeroproc_freeze")
    timer_aeroproc_subl     = new_timer("aeroproc_subl")
    timer_aeroproc_coll     = new_timer("aeroproc_coll")
!<<DN: aerosol processing
