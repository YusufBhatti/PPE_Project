...
!>>SF
#ifdef HAMMOZ
    REAL(wp), INTENT(inout) :: pxtbound(kbdim,ktrac) !SF boundary condition for xt_conv_massfix
#endif
!<<SF
    !
...
!>>SF Missing initialization of zxtec
    zxtec(1:kproma,:) = 0._wp
!<<SF
    !----------------------------------------------------------------------
    !
