Template created by David Neubauer (david.neubauer@env.ethz.ch) on 2023-07-13_16.46.
...
Years 1750-1849 (after 6 months of spin-up). Note that the historical experiment was split into several time periods (simulations) to reduce the time required for the simulation (all using 6 months of spin-up).
