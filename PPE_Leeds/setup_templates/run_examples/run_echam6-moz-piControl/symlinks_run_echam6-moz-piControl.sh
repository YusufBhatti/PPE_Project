...
# csld land use transition and harvest files (needed because lcc_forcing_type = 'transitions' in JSBACH's namelist)
for ((year=$start_year_m1; year<=$stop_year_p1; year++)) ; do	
	ln -s ${input_basepath}/jsbach/${hres}/New_Hampshire_LCC/no_LUH_transitions_${hres}.nc landuseTransitions.${year}.nc 
	ln -s ${input_basepath}/jsbach/${hres}/New_Hampshire_LCC/hist/LUH_harvest_${hres}_1850.nc landuseHarvest.${year}.nc
done
#--------------------------
...
#CSW
       ...
       ln -sf ${input_basepath}/echam6/${hres}/aero/${hres}_aeropt_kinne_sw_b14_fin_${scenario_str}1865.nc aero_fine_${year}.nc
...
#CSW
      ...
      ln -sf  ${input_basepath}/hammoz/${hres}/moz_b40.1850.track1.2deg.wcm.007_0156-01_tracer_ic_${hres}${vres}.nc tracer_ic.nc
...
#CSW
      ...
      ln -sf ${input_basepath}/hammoz/${hres}/moz_sad_sulf_piControl_c080220_${hres}${vres}.nc moz_sad_sulf.${hres}.nc
...
#CSW
      ...
      ln -sf ${input_basepath}/hammoz/${hres}/hammoz_lbc_CCMI_piControl_za_c130313_${hres}.nc moz_lbc.${hres}.nc
