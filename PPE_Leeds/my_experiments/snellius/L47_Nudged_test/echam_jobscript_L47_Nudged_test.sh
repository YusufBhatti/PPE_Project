#!/bin/bash
#SBATCH --job-name="L47_Nudged_test"
#SBATCH --nodes=1
#SBATCH --ntasks=60
#SBATCH --time=25:00:00
#SBATCH --partition genoa
###SBATCH --output=slurm_L47_Nudged_test_%j.txt
###SBATCH --error=slurm_L47_Nudged_test_%j.txt
#SBATCH --output=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/L47_Nudged_test/L47_Nudged_test.out
#SBATCH --error=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/L47_Nudged_test/L47_Nudged_test.err
...
cd /projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/L47_Nudged_test/
...
if $flag_p_proc ; then # this submits a job to be executed on the p-proc machine julier.cscs.ch. 
   ...
   declare -x exp=L47_Nudged_test
   declare -x exp_dir=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/L47_Nudged_test/
   declare -x p_proc_dir=/path/to/post_proc_disk/ybhatti/L47_Nudged_test
...
#                       --ntasks=1 \
#                       --time=XX:XX:XX \
#                       --output=/gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/L47_Nudged_test/slurm_p-proc_%j.txt \
#                       --error=/gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/L47_Nudged_test/slurm_p-proc_%j.txt \
#                       --account="srsei8447" \
#                       --export=ALL \
#                             /path/to/some/post-processing script
   ...
   sbatch -M julier \
                       ...
                       --ntasks=1 \
                       --time=XX:XX:XX \
                       --output=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/L47_Nudged_test/L47_Nudged_test.out \
                       --error=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/L47_Nudged_test/L47_Nudged_test.err \
                       --account="srsei8447" \
                       --export=ALL \
                             /path/to/some/post-processing script
...
rerun_echam="restart_L47_Nudged_test_echam.nc"

if [ -e ${rerun_echam} ] ; then
   rerun_date=`ncdump -h ${rerun_echam} | grep ":vdate =" | cut -c12-19`
   rerun_tar=restart_L47_Nudged_test_${rerun_date}.tar

   tar cvf $rerun_tar restart_L47_Nudged_test_[a-z]*
else
...
#--- Submit the next job:
   ...
   if [[ "$status_echam" -eq "0" ]] ; then
      cd /gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/L47_Nudged_test
      sbatch /gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/L47_Nudged_test/echam_jobscript_L47_Nudged_test.sh
   fi
