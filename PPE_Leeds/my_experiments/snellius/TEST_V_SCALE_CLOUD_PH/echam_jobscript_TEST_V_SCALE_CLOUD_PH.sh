#!/bin/bash
#SBATCH --job-name="TEST_V_SCALE_CLOUD_PH"
#SBATCH --nodes=1
#SBATCH --ntasks=40
...
#SBATCH --error=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_SCALE_CLOUD_PH/TEST_V_SCALE_CLOUD_PH.err
...
cd /projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_SCALE_CLOUD_PH/
...
if $flag_p_proc ; then # this submits a job to be executed on the p-proc machine julier.cscs.ch. 
   ...
   declare -x exp=TEST_V_SCALE_CLOUD_PH
   declare -x exp_dir=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_SCALE_CLOUD_PH/
   declare -x p_proc_dir=/path/to/post_proc_disk/ybhatti/TEST_V_SCALE_CLOUD_PH
...
#                       --ntasks=1 \
#                       --time=XX:XX:XX \
#                       --output=/gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/TEST_V_SCALE_CLOUD_PH/slurm_p-proc_%j.txt \
#                       --error=/gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/TEST_V_SCALE_CLOUD_PH/slurm_p-proc_%j.txt \
#                       --account="srsei9480" \
#                       --export=ALL \
#                             /path/to/some/post-processing script
   ...
   sbatch -M julier \
                       ...
                       --ntasks=1 \
                       --time=XX:XX:XX \
                       --output=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_SCALE_CLOUD_PH/TEST_V_SCALE_CLOUD_PH.out \
                       --error=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_SCALE_CLOUD_PH/TEST_V_SCALE_CLOUD_PH.err \
                       --account="srsei9480" \
                       --export=ALL \
                             /path/to/some/post-processing script
...
rerun_echam="restart_TEST_V_SCALE_CLOUD_PH_echam.nc"

if [ -e ${rerun_echam} ] ; then
   rerun_date=`ncdump -h ${rerun_echam} | grep ":vdate =" | cut -c12-19`
   rerun_tar=restart_TEST_V_SCALE_CLOUD_PH_${rerun_date}.tar

   tar cvf $rerun_tar restart_TEST_V_SCALE_CLOUD_PH_[a-z]*
else
...
#--- Submit the next job:
   ...
   if [[ "$status_echam" -eq "0" ]] ; then
      cd /gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/TEST_V_SCALE_CLOUD_PH
      sbatch /gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/TEST_V_SCALE_CLOUD_PH/echam_jobscript_TEST_V_SCALE_CLOUD_PH.sh
   fi
