...
input_basepath="/projects/0/prjs0937/yusufb/MODEL_INPUT/v0002_input" # where all input files except nudging data is to be found
nudg_basepath="/projects/0/prjs0937/yusufb/MODEL_INPUT/Nudging_tmp/era5_T63L31_netcdf" # where all nudging data is to be found
