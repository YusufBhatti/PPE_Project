#!/bin/bash
#SBATCH --job-name="TEST_V_EMI_BC"
#SBATCH --nodes=0
#SBATCH --ntasks=60
#SBATCH --time=25:00:00
#SBATCH --partition rome
###SBATCH --output=slurm_TEST_V_EMI_BC_%j.txt
###SBATCH --error=slurm_TEST_V_EMI_BC_%j.txt
#SBATCH --output=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_EMI_BC/TEST_V_EMI_BC.out
#SBATCH --error=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_EMI_BC/TEST_V_EMI_BC.err
...
cd /projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_EMI_BC/
...
if $flag_p_proc ; then # this submits a job to be executed on the p-proc machine julier.cscs.ch. 
   ...
   declare -x exp=TEST_V_EMI_BC
   declare -x exp_dir=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_EMI_BC/
   declare -x p_proc_dir=/path/to/post_proc_disk/ybhatti/TEST_V_EMI_BC
...
#                       --ntasks=1 \
#                       --time=24:00:00 \
#                       --output=/gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/PPE_Debug/TEST_V_EMI_BC/slurm_p-proc_%j.txt \
#                       --error=/gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/PPE_Debug/TEST_V_EMI_BC/slurm_p-proc_%j.txt \
#                       --account="srsei8447" \
#                       --export=ALL \
#                             /path/to/some/post-processing script
   ...
   sbatch -M julier \
                       ...
                       --ntasks=1 \
                       --time=24:00:00 \
                       --output=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_EMI_BC/TEST_V_EMI_BC.out \
                       --error=/projects/0/prjs0937/yusufb/ECHAM/OUTPUT//snellius/DEBUG/TEST_V_EMI_BC/TEST_V_EMI_BC.err \
                       --account="srsei8447" \
                       --export=ALL \
                             /path/to/some/post-processing script
...
rerun_echam="restart_TEST_V_EMI_BC_echam.nc"

if [ -e ${rerun_echam} ] ; then
   rerun_date=`ncdump -h ${rerun_echam} | grep ":vdate =" | cut -c12-19`
   rerun_tar=restart_TEST_V_EMI_BC_${rerun_date}.tar

   tar cvf $rerun_tar restart_TEST_V_EMI_BC_[a-z]*
else
...
#--- Submit the next job:
   ...
   if [[ "$status_echam" -eq "0" ]] ; then
      cd /gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/PPE_Debug/TEST_V_EMI_BC
      sbatch /gpfs/work3/0/prjs0937/yusufb/Branches/PPE_Leeds/my_experiments/snellius/PPE_Debug/TEST_V_EMI_BC/echam_jobscript_TEST_V_EMI_BC.sh
   fi
