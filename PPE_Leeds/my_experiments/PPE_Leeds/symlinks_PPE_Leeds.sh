...
nudg_basepath="/home/ybhatti/yusufb/MODEL_INPUT/Nudging/era5_T63L47/" # where all nudging data is to be found
...
if $flag_nudg ; then
   ...
   if [ -z $nudg_prefix_order ] ; then 
      declare -a nudg_prefix_order=( "eraia" "era40"  "ana" "era5")
   fi
