...
MODULE mo_hammoz_perturbations
  ...
  REAL(dp)    :: bl_nuc, & ! scalable - done
                 ...
                 so2o3_clean, & ! ?
                 so2o3_poll, & ! ?
                 nuc_scav_diam, & ! scalable
                 nuc_scav_ice, & ! scalable
                 drydep_aer_ait, & ! scalable - done
                 ...
                 prim_so4_frac, & ! scalable - done in mo_ham_m7_emissions
                 prim_s04_diam, & ! scalable - done in mo_ham_m7_emissions
                 ss_acc, & ! scalable
                 anth_s02, & ! scalable
                 volc_so2, & ! scalable
                 dms_flux, & ! scalable
  ...
  REAL(dp)    :: scale_nuc_bl = 1.0_dp, &     ! Scale factor for BL nucleation scheme (activation or kinetic)
                 scale_nuc_ft = 1.0_dp, &     ! Scale factor for free tropospheric nucleation scheme (Vehkamaeki or Kazil & Lovejoy)
                 ...
                 scale_emi_cmr_bf = 1.0_dp, & ! Scale factor for emission count median raduius for biofuel
...
!    ENDIF
   ...
   ! CALL print_value('Emission of primary SO4 - radius of emitted SO4         ', emi_prim_so4_cmr)
    ...
    CALL message('','---')
    CALL print_value('Dry deposition velocity scaling factor (scale_drydep_ait)', scale_drydep_ait)
    CALL print_value('Dry deposition velocity scaling factor (scale_drydep_acc)', scale_drydep_acc)
    CALL print_value('Dry deposition velocity scaling factor (scale_drydep_coa)', scale_drydep_coa)
