...
#SBATCH --output=/home/ybhatti2/prjs1474/Pace_PPE_Output/Jasper_echam/Test/Test.out
#SBATCH --error=/home/ybhatti2/prjs1474/Pace_PPE_Output/Jasper_echam/Test/Test.err
...
cd /home/ybhatti2/prjs1474/Pace_PPE_Output/Jasper_echam/Test/
...
#cwd=/home/ybhatti2/prjs1474/Pace_PPE_Output/Jasper_echam/Test/
...
if $flag_p_proc ; then # this submits a job to be executed on the p-proc machine julier.cscs.ch. 
   ...
   declare -x exp=Test
   declare -x exp_dir=/home/ybhatti2/prjs1474/Pace_PPE_Output/Jasper_echam/Test/
...
#                       --ntasks=1 \
#                       --time=24:00:00 \
#                       --output=/gpfs/work3/0/prjs1474/ybhatti/PPE_Project/Jasper_echam/my_experiments/Test/slurm_p-proc_%j.txt \
#                       --error=/gpfs/work3/0/prjs1474/ybhatti/PPE_Project/Jasper_echam/my_experiments/Test/slurm_p-proc_%j.txt \
#                       --account="srs25001" \
#                       --export=ALL \
#                             /path/to/some/post-processing script
   ...
   sbatch -M julier \
                       ...
                       --ntasks=1 \
                       --time=24:00:00 \
                       --output=/home/ybhatti2/prjs1474/Pace_PPE_Output/Jasper_echam/Test/Test.out \
                       --error=/home/ybhatti2/prjs1474/Pace_PPE_Output/Jasper_echam/Test/Test.err \
                       --account="srs25001" \
                       --export=ALL \
                             /path/to/some/post-processing script
...
#--- Submit the next job:
   ...
   if [[ "$status_echam" -eq "0" ]] ; then
      cd /gpfs/work3/0/prjs1474/ybhatti/PPE_Project/Jasper_echam/my_experiments/Test
      sbatch /gpfs/work3/0/prjs1474/ybhatti/PPE_Project/Jasper_echam/my_experiments/Test/echam_jobscript_Test.sh
   fi
