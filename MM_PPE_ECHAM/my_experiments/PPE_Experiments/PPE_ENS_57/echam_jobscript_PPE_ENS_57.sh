...
#SBATCH --output=/home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57/PPE_ENS_57.out
#SBATCH --error=/home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57/PPE_ENS_57.err
...
cd /home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57/
...
#cwd=/home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57/
...
target="/home/ybhatti2/prjs1474/Utils/CDO_Scripts/CDO_PP/PPE_ENS_57.sh"
...
# Copy the CDO.sh template to a new script based on jobname
#cp -f /home/ybhatti2/prjs1474/Utils/CDO_Scripts/PPE_ENS_Example.sh /home/ybhatti2/prjs1474/Utils/CDO_Scripts/CDO_PP/PPE_ENS_57.sh
cp -f /home/ybhatti2/prjs1474/Utils/CDO_Scripts/PPE_ENS_Defaults.sh /home/ybhatti2/prjs1474/Utils/CDO_Scripts/CDO_PP/PPE_ENS_57.sh

# Update placeholders inside the copied script in a single sed call
sed -i     -e "6c jobname='PPE_ENS_57'"     -e "7c name=\"/home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57\""     "/home/ybhatti2/prjs1474/Utils/CDO_Scripts/CDO_PP/PPE_ENS_57.sh"
...
. /home/ybhatti2/prjs1474/Utils/CDO_Scripts/CDO_PP/PPE_ENS_57.sh
...
if $flag_p_proc ; then # this submits a job to be executed on the p-proc machine julier.cscs.ch. 
   ...
   declare -x exp_dir=/home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57/
...
#                       --ntasks=1 \
#                       --time=24:00:00 \
#                       --output=/gpfs/work3/0/prjs1474/ybhatti/PPE_Project/PPE_PACE_Project/my_experiments/PPE_Experiments/PPE_ENS_57/slurm_p-proc_%j.txt \
#                       --error=/gpfs/work3/0/prjs1474/ybhatti/PPE_Project/PPE_PACE_Project/my_experiments/PPE_Experiments/PPE_ENS_57/slurm_p-proc_%j.txt \
#                       --account="srs25001" \
#                       --export=ALL \
#                             /path/to/some/post-processing script
   ...
   sbatch -M julier \
                       ...
                       --ntasks=1 \
                       --time=24:00:00 \
                       --output=/home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57/PPE_ENS_57.out \
                       --error=/home/ybhatti2/prjs1474/Pace_PPE_Output/PPE_Experiments/PPE_ENS_57/PPE_ENS_57.err \
                       --account="srs25001" \
                       --export=ALL \
                             /path/to/some/post-processing script
...
#--- Submit the next job:
   ...
   if [[ "$status_echam" -eq "0" ]] ; then
      cd /gpfs/work3/0/prjs1474/ybhatti/PPE_Project/PPE_PACE_Project/my_experiments/PPE_Experiments/PPE_ENS_57
      sbatch /gpfs/work3/0/prjs1474/ybhatti/PPE_Project/PPE_PACE_Project/my_experiments/PPE_Experiments/PPE_ENS_57/echam_jobscript_PPE_ENS_57.sh
   fi
