...
input_basepath="/cluster/work/climate/ferrachs/echam_input/echam6-hammoz/${input_files_version}" # where all input files except nudging data is to be found
nudg_basepath="/cluster/work/climate/ferrachs/echam_input/echam_nudging_DKRZ" # where all nudging data is to be found
