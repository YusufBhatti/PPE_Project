...
if $this_model_flag_with_hammoz ; then # echam6-hammoz specific
   ...
   for ((year=$start_year_m1; year<=$stop_year_p1; year++)) ; do
           ln -sf /project/s1144/uproske/aeroclim_climatologies/aeroclim_ll_default_05_correcttimestamp/2003-2012_CCN_maxofact.nc ccn${year}.nc
           ln -sf /project/s1144/uproske/aeroclim_climatologies/aeroclim_ll_default_05_correcttimestamp/2003-2012_IN.nc in${year}.nc
   done
   #<<UP
