...
Years 1850-1899 (after 6 months of spin-up). Note that the historical experiment was split into several time periods (simulations) to reduce the time required for the simulation (all using 6 months of spin-up).
