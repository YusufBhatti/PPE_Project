...
Years 2015-2017 (after 6 months of spin-up). Note that the historical experiment was split into several time periods (simulations) to reduce the time required for the simulation (all using 6 months of spin-up). For the years 2015-2017, CMIP6 ssp370 scenario emissions were used.
