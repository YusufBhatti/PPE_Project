...
MODULE mo_echam_cloud_params
  ...
  USE mo_param_switches,     ONLY: t_csecfrl
#ifdef __ICON__
  ...
  !SF REAL(wp),    PARAMETER :: ccsaut  = 95.0_wp
  ...
  !SF REAL(wp),    PARAMETER :: ccraut  = 15.0_wp
  REAL(wp)               :: ccraut  = 15.0_wp
...
!>> RD tuning
    csecfrl = t_csecfrl
    CALL print_value('csecfrl = ', t_csecfrl)
!<< RD tuning
