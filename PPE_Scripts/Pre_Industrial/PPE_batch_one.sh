...
#--- user settings ---
nexp_maxrunning=1    # number of concurrent jobs
nexp_maxran=1      # max total jobs (big number = all)

cwd=${PWD}/
PPEdir='/home/ybhatti2/prjs1474/PPE_Project/PPE_PACE_Project/my_experiments/PI_PPE_Experiments/'
PPElog=$cwd'PPE_log2.txt'
PPEtmp=$cwd'PPE_tmp2.txt'
PPEvalues=$cwd'PPE_values_one.txt'
