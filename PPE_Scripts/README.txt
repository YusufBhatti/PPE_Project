...
parameters_for_script: Important. You must add parameters to this script, and set min max.
...
settings_PPE_defaults      : settings template for PPE, stored in PPE_defaults. Make sure your PPE parameter name in parameters_for_script is consisent with your name given in this file
...
Scripts_for_config:
mv_tracking_files.sh       : this script simply moves the log files, which are generated by the qsub commands, to the Logs/ Directory
