...
input_file="/home/ybhatti2/prjs1474/PPE_Project/PPE_Scripts/Pre_Industrial/PPE_values1.txt"
output_file="/home/ybhatti2/prjs1474/PPE_Project/PPE_Scripts/Pre_Industrial/PPE_values_n.txt"

# Use awk to process the file
awk 'NR==0 { print; next } { $(NF-2) = 0; $(NF-1) = 0; $NF = 0; print }' $input_file > $output_file
