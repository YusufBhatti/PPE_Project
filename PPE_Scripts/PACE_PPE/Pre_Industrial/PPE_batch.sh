...
#--- user settings ---
nexp_maxrunning=25    # number of concurrent jobs
nexp_maxran=125      # max total jobs (big number = all)

cwd=${PWD}/
PPEdir='/home/ybhatti2/prjs1474/PPE_Project/PPE_PACE_Project/my_experiments/PI_PPE_Experiments/'
PPElog=$cwd'PPE_log1.txt'
PPEtmp=$cwd'PPE_tmp1.txt'
PPEvalues=$cwd'PPE_values1.txt'
